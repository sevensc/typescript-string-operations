import { $String as String, StringBuilder } from '../src/index';
import { Fruit } from './fruit';
import { expect } from 'chai';
import 'mocha';

describe('String.IsNullOrWhitespace (DEPRECATED METHODS)', () => {
...
describe('String.Format Number Pattern (DEPRECATED METHODS)', () => {
...
describe('String.Format Text Pattern (DEPRECATED METHODS)', () => {
    describe("formatting", () => {
...
describe('String.Join (DEPRECATED METHODS)', () => {
...
describe('String.Append (DEPRECATED METHODS)', () => {
